...
> Долг по правилу 3: гейт доступа по роутам пока не реализован — карточки на главной
> фильтруются по ролям, но прямой URL к чужой апке открыт любому залогиненному
> (см. `docs/PORTAL-STATUS.md`).
